...
PAGES = {
    ...
    "bathtub-and-shower-remodeling-contractor": {
        ...
        "section_imgs": [
            ("images-p2-sections/p2-section-1.avif", "Walk-in shower install, Greater New Orleans"),
            ("images-p2-sections/p2-section-2.avif", "Tub-to-shower conversion by TurnKey"),
            ("images-p2-sections/p2-section-3.avif", "Acrylic shower system, no grout to clean"),
            ("images-p2-sections/p2-section-4.avif", "Barrier-free shower install, New Orleans"),
            ("images-p2-sections/p2-section-5.avif", "Fixed-price shower install quote"),
            ("images-p2-sections/p2-section-6.avif", "Licensed New Orleans shower remodeling crew"),
            ("images-p2-sections/p2-section-7.avif", "Walk-in shower replacement, Metairie"),
            ("images-p2-sections/p2-section-8.avif", "Tub-to-shower conversion service area New Orleans"),
        ],
        "video_after_index": 2,
        "faqs": [
...
<!-- HERO -->
<section class="hero" style="background-image: linear-gradient(135deg, rgba(2,31,53,.88) 0%, rgba(5,42,69,.82) 60%, rgba(7,58,93,.78) 100%), url('{data["hero_bg"]}');">
